...
This algorithm was based on **[1]**. The definition of the unnormalized associated Legendre
function can be seen in **[2]**.
...
function unnormalized_legendre!(
    ...
    return _legendre_kernel!(P, ϕ, Val(:unnormalized), n_max, m_max, ph_term, T)
end
